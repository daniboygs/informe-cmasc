<form id="folders-to-validation-form" action="#">	
	...
	<div class="form-buttons">
		<button type="button" class="btn btn-primary" style="height:38px; float: left;"  onclick="softLoadForm('folders_to_validation')">Capturar <i class="fa fa-pencil" aria-hidden="true"></i></button>		
