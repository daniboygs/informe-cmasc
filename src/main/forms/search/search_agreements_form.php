<form id="agreements-form" action="#">	
	...
	<div class="form-buttons">
		<button type="button" class="btn btn-primary" style="height:38px; float: left;"  onclick="softLoadForm('agreements')">Capturar <i class="fa fa-pencil" aria-hidden="true"></i></button>		
