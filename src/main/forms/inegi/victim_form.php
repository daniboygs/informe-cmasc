<form id="inegi-victim-form" action="#">	
	...
	<div class="form-row">
		...
		<div class="col-md-6 form-group">
			...
			<select class="form-control" id="inegi-victim-applicant" required="true">
	...
	<div class="form-buttons">		
		...
		<button type="button" class="btn btn-outline-primary" style="height:38px; width: 100px;"  onclick="validateInegiSection('victim')">Guardar</button>	
