<form id="people-served-form" action="#">	
	...
	<div class="form-row">
		...
		<div class="col-md-2 form-group">
			...
			<input type="text" class="form-control" id="people-served-nuc" maxlength="15" onkeypress="validateNumber(event);">			
	...
	<div class="form-row">
		...
		<div class="col-md-3 form-group">
			...
			<!--<input type="text" class="form-control" id="people-served-age" maxlength="3" onkeypress="validateNumber(event);">-->
