...
$pdf2->SetFont('Arial','',8);
$pdf2->Cell(121, 5, "", "", "", 'C');
$pdf2->Cell(50, 5, iconv('UTF-8', 'windows-1252', '1151544515412152'), "", "", 'L');
...
set_paragraph($pdf2, 2, $year);

$pdf2->Ln(10);

set_paragraph($pdf2, 3, $year);
...
/*$pdf2->Cell(185, 80, iconv('UTF-8', 'windows-1252', 'ATENTAMENTE'), "", "", 'C');
$pdf2->Ln(5);
$pdf2->Cell(185, 80, iconv('UTF-8', 'windows-1252', 'LIC. NOE MARTINEZ PONCE '), "", "", 'C');
$pdf2->Ln(5);
$pdf2->Cell(185, 80, iconv('UTF-8', 'windows-1252', 'AGENTE DEL MINISTERIO PUBLICO ADSCRITO'), "", "", 'C');
$pdf2->Ln(-5);
$pdf2->Cell(185, 80, iconv('UTF-8', 'windows-1252', 'A LA DIRRECCION DE ACUERDOS REPARATORIOS DEL CENTRO'), "", "", 'C');
$pdf2->Ln(-5);
$pdf2->Cell(185, 80, iconv('UTF-8', 'windows-1252', 'DE MECANISMOS ALTERNATIVOS DE SOLUCIÓN DE CONTROVERSÍAS'), "", "", 'C');*/
...
$pdf2->Image('../../../../assets/img/pdf_2.jpg', 15, 0, 183);
...
function set_paragraph($pdf2, $section, $year){
    ...
    switch($section){
        ...
        case 2:
            $pdf2->SetFont('','');
            $pdf2->Cell(10, 6, "", "", "", 'C');
            $pdf2->MultiCell(170,6,iconv('UTF-8', 'windows-1252', 'Por medio del presente y en atención a su oficio de canalización, se remite la carpeta original de investigación citada en rubro, misma que nos fue enviada para someterse a los medios alternos de solución de controversias. Informo a usted que una vez analizado el contenido de la presente carpeta, los presentes hechos NO son susceptibles de resolverse a través de un mecanismo alternativo, ya que no entra en los supuestos por lo establecido en los artículos 186 y 187 del Código Nacional de Procedimientos Penales; o no cumple con los requisitos de admisibilidad, lo anterior con fundamento en lo establecido en los artículos 9, 10,11 y 12 de la ley Nacional de Mecanismos Alternativos de Solución de Controversias en materia Penal. Es por eso que este órgano, estima que no es procedente realizar el mecanismo. Lo anterior para los efectos legales que haya lugar.'), 'J');
        break;
        case 3:
            $pdf2->SetFont('','');
            $pdf2->Cell(10, 6, "", "", "", 'C');
