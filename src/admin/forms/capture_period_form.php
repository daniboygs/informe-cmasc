...
<div class="subtitle-label-section">CAPTURA CARPETAS INGRESADAS</div>

<form id="capture-entered-period-form" action="#">
	...
	<div class="form-row">
		...
		<div class="col-md-6 form-group">
			...
			<input type="date" class="form-control" id="capture-entered-folders-period-initial-date">	
		...
		<div class="col-md-6 form-group">
			...
			<input type="date" class="form-control" id="capture-entered-folders-period-finish-date">	
	...
	<div class="form-row">
		...
		<div class="col-md-4 form-group">
			...
			<input type="checkbox" id="capture-entered-folders-period-daily" value="second_checkbox" onchange="onChangeEnteredFoldersDaily()">	
	...
	<div class="form-buttons">	
		...
		<div class="period-label" id="capture-entered-folders-period-label"><div style="color: #EE6E5A;">Cargando datos... </div></div>	

		<button type="button" class="btn btn-outline-success" style="height:38px; width: 100px;" onclick="activateEnteredFoldersPeriod()">Habilitar</button>
