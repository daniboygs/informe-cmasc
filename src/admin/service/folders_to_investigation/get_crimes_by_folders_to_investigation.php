...
if($sql_conditions != null){
	...
	$sql = "SELECT a.[CarpetaEnviadaInvestigacionID] AS 'id',
			cd.Nombre AS 'Delito'
			FROM [EJERCICIOS].[dbo].[CarpetasEnviadasInvestigacion] a 
			INNER JOIN [delitos].[CarpetasEnviadasInvestigacion] d ON d.CarpetaEnviadaInvestigacionID = a.CarpetaEnviadaInvestigacionID
