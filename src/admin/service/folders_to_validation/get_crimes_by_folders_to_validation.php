...
if($sql_conditions != null){
	...
	$sql = "SELECT a.[CarpetaEnviadaValidacionID] AS 'id',
			cd.Nombre AS 'Delito'
			FROM [EJERCICIOS].[dbo].[CarpetasEnviadasValidacion] a 
			INNER JOIN [delitos].[CarpetasEnviadasValidacion] d ON d.CarpetaEnviadaValidacionID = a.CarpetaEnviadaValidacionID
