...
?> 
    <tr>
        ...
        <td style="text-align: center; border: solid 1px #ccc;"><?php echo $element['folders_to_validation_nuc']['value']; ?></td>
        <td style="text-align: center; border: solid 1px #ccc;"><?php echo $element['folders_to_validation_date']['value']; ?></td>
